...
def update_env():
    ...
    try:
        ...
        logging.error(f"Error updating environment variables: {str(e)}", exc_info=True)
...
def purge_database():
    ...
    try:
        ...
        logging.error(f"Error purging database: {str(e)}", exc_info=True)
...
def restart():
    ...
    try:
        ...
        logging.error(f"Error restarting server: {str(e)}", exc_info=True)
